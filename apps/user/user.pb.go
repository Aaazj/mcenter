...
type Meta struct {
	...
	// 对象全称
	// @gotags: bson:"full_id" json:"full_id"
	FullId string `protobuf:"bytes,2,opt,name=full_id,json=fullId,proto3" json:"full_id" bson:"full_id"`
	// 创建时间
	// @gotags: bson:"create_at" json:"create_at"
...
type Profile struct {
	...
	Gender Gender `protobuf:"varint,6,opt,name=gender,proto3,enum=mcenter.user.Gender" json:"gender" bson:"gender" validate:"lte=10"`
	// 头像
...
type CreateUserRequest struct {
	...
	Provider PROVIDER `protobuf:"varint,1,opt,name=provider,proto3,enum=mcenter.user.PROVIDER" json:"provider" bson:"provider"`
	// 用户类型
	// @gotags: json:"type" bson:"type"
	Type TYPE `protobuf:"varint,2,opt,name=type,proto3,enum=mcenter.user.TYPE" json:"type" bson:"type"`
	// 创建类型
	// @gotags: json:"create_by" bson:"create_by"
	CreateBy CREATE_BY `protobuf:"varint,3,opt,name=create_by,json=createBy,proto3,enum=mcenter.user.CREATE_BY" json:"create_by" bson:"create_by"`
	// 域信息
	...
	Username string `protobuf:"bytes,6,opt,name=username,proto3" json:"username" bson:"username" validate:"required,lte=60"`
	// 密码相关信息
	// @gotags: json:"password" bson:"-" validate:"required,lte=80"
	Password string `protobuf:"bytes,7,opt,name=password,proto3" json:"password" bson:"-" validate:"required,lte=80"`
	// 用户描述
	...
	Labels map[string]string `protobuf:"bytes,9,rep,name=labels,proto3" json:"labels" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"labels"`
	// 使用全名作为uid, 比如 admin@default, 默认使用uuid
	// @gotags: json:"use_full_named_uid" bson:"use_full_named_uid"
	UseFullNamed bool `protobuf:"varint,10,opt,name=use_full_named,json=useFullNamed,proto3" json:"use_full_named_uid" bson:"use_full_named_uid"`
}
...
func (x *CreateUserRequest) GetUseFullNamed() bool {
	if x != nil {
		return x.UseFullNamed
	}
	return false
}
...
var file_mcenter_apps_user_pb_user_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0c, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x22,
	0x86, 0x02, 0x0a, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x1a, 0x0a, 0x08,
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61,
	...
	,
	...
	,
	...
	0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0x9b, 0x02, 0x0a, 0x07, 0x50, 0x72,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e,
	...
	,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	...
	,
	...
	0x46, 0x45, 0x4d, 0x41, 0x4c, 0x45, 0x10, 0x02, 0x2a, 0x20, 0x0a, 0x09, 0x43, 0x52, 0x45, 0x41,
	0x54, 0x45, 0x5f, 0x42, 0x59, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x10, 0x00,
	0x12, 0x08, 0x0a, 0x04, 0x53, 0x45, 0x4c, 0x46, 0x10, 0x01, 0x2a, 0x29, 0x0a, 0x0b, 0x44, 0x45,
	0x53, 0x43, 0x52, 0x49, 0x42, 0x45, 0x5f, 0x42, 0x59, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x53, 0x45,
	0x52, 0x5f, 0x49, 0x44, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x4e,
	0x41, 0x4d, 0x45, 0x10, 0x01, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x61, 0x61, 0x7a, 0x6a, 0x2f, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65,
...
var file_mcenter_apps_user_pb_user_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_mcenter_apps_user_pb_user_proto_goTypes = []interface{}{
	(PROVIDER)(0),             // 0: mcenter.user.PROVIDER
	(TYPE)(0),                 // 1: mcenter.user.TYPE
	(Gender)(0),               // 2: mcenter.user.Gender
	(CREATE_BY)(0),            // 3: mcenter.user.CREATE_BY
	(DESCRIBE_BY)(0),          // 4: mcenter.user.DESCRIBE_BY
	(*Password)(nil),          // 5: mcenter.user.Password
	(*Status)(nil),            // 6: mcenter.user.Status
	(*User)(nil),              // 7: mcenter.user.User
	(*Meta)(nil),              // 8: mcenter.user.Meta
	(*Profile)(nil),           // 9: mcenter.user.Profile
	(*CreateUserRequest)(nil), // 10: mcenter.user.CreateUserRequest
	(*UserSet)(nil),           // 11: mcenter.user.UserSet
	nil,                       // 12: mcenter.user.CreateUserRequest.LabelsEntry
}
var file_mcenter_apps_user_pb_user_proto_depIdxs = []int32{
	8,  // 0: mcenter.user.User.meta:type_name -> mcenter.user.Meta
	10, // 1: mcenter.user.User.spec:type_name -> mcenter.user.CreateUserRequest
	9,  // 2: mcenter.user.User.profile:type_name -> mcenter.user.Profile
	5,  // 3: mcenter.user.User.password:type_name -> mcenter.user.Password
	6,  // 4: mcenter.user.User.status:type_name -> mcenter.user.Status
	2,  // 5: mcenter.user.Profile.gender:type_name -> mcenter.user.Gender
	0,  // 6: mcenter.user.CreateUserRequest.provider:type_name -> mcenter.user.PROVIDER
	1,  // 7: mcenter.user.CreateUserRequest.type:type_name -> mcenter.user.TYPE
	3,  // 8: mcenter.user.CreateUserRequest.create_by:type_name -> mcenter.user.CREATE_BY
	12, // 9: mcenter.user.CreateUserRequest.labels:type_name -> mcenter.user.CreateUserRequest.LabelsEntry
	7,  // 10: mcenter.user.UserSet.items:type_name -> mcenter.user.User
