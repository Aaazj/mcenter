...
type QueryTokenRequest struct {
	...
	Platform *PLATFORM `protobuf:"varint,2,opt,name=platform,proto3,enum=mcenter.token.PLATFORM,oneof" json:"platform" bson:"platform"`
	// 访问令牌
	// @gotags: json:"access_token"
	...
	UserType *user.TYPE `protobuf:"varint,5,opt,name=user_type,json=userType,proto3,enum=mcenter.user.TYPE,oneof" json:"user_type"`
	// 用户当前所处域
	// @gotags: json:"domain"
	...
	GrantType *GRANT_TYPE `protobuf:"varint,9,opt,name=grant_type,json=grantType,proto3,enum=mcenter.token.GRANT_TYPE,oneof" json:"grant_type"`
	// 令牌类型
	// @gotags: json:"type"
	Type *TOKEN_TYPE `protobuf:"varint,10,opt,name=type,proto3,enum=mcenter.token.TOKEN_TYPE,oneof" json:"type"`
	// 当前空间
	...
	BlockType *BLOCK_TYPE `protobuf:"varint,14,opt,name=block_type,json=blockType,proto3,enum=mcenter.token.BLOCK_TYPE,oneof" json:"block_type"`
}
...
type DescribeTokenRequest struct {
	...
	DescribeBy DESCRIBY_BY `protobuf:"varint,1,opt,name=describe_by,json=describeBy,proto3,enum=mcenter.token.DESCRIBY_BY" json:"describe_by"`
	// 参数值
...
var file_mcenter_apps_token_pb_rpc_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0d, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x74, 0x6f, 0x1a, 0x21, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x70, 0x73,
	0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2f, 0x70, 0x62, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x39, 0x0a, 0x14, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	...
	0x22, 0x5c, 0x0a, 0x12, 0x52, 0x65, 0x76, 0x6f, 0x6c, 0x6b, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52,
	...
	0x0a, 0x16, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63,
	...
	0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0xb1, 0x05, 0x0a,
	0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x75, 0x65, 0x73, 0x74, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x12, 0x38, 0x0a, 0x08, 0x70, 0x6c,
	0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x6d,
	0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x50, 0x4c, 0x41,
	0x54, 0x46, 0x4f, 0x52, 0x4d, 0x48, 0x00, 0x52, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72,
	0x6d, 0x88, 0x01, 0x01, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x74,
	...
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x34, 0x0a, 0x09,
	...
	0x59, 0x50, 0x45, 0x48, 0x01, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x88,
	0x01, 0x01, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x06, 0x20, 0x01,
	...
	0x3d, 0x0a, 0x0a, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x2e, 0x47, 0x52, 0x41, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x48, 0x02,
	0x52, 0x09, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x12, 0x32,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6d,
	...
	,
	...
	0x6d, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_mcenter_apps_token_pb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_mcenter_apps_token_pb_rpc_proto_goTypes = []interface{}{
	(DESCRIBY_BY)(0),               // 0: mcenter.token.DESCRIBY_BY
	(*ValidateTokenRequest)(nil),   // 1: mcenter.token.ValidateTokenRequest
	(*RevolkTokenRequest)(nil),     // 2: mcenter.token.RevolkTokenRequest
	(*ChangeNamespaceRequest)(nil), // 3: mcenter.token.ChangeNamespaceRequest
	(*QueryTokenRequest)(nil),      // 4: mcenter.token.QueryTokenRequest
	(*DescribeTokenRequest)(nil),   // 5: mcenter.token.DescribeTokenRequest
	(*request.PageRequest)(nil),    // 6: infraboard.mcube.page.PageRequest
	(PLATFORM)(0),                  // 7: mcenter.token.PLATFORM
	(user.TYPE)(0),                 // 8: mcenter.user.TYPE
	(GRANT_TYPE)(0),                // 9: mcenter.token.GRANT_TYPE
	(TOKEN_TYPE)(0),                // 10: mcenter.token.TOKEN_TYPE
	(BLOCK_TYPE)(0),                // 11: mcenter.token.BLOCK_TYPE
	(*Token)(nil),                  // 12: mcenter.token.Token
}
var file_mcenter_apps_token_pb_rpc_proto_depIdxs = []int32{
	6,  // 0: mcenter.token.QueryTokenRequest.page:type_name -> infraboard.mcube.page.PageRequest
	7,  // 1: mcenter.token.QueryTokenRequest.platform:type_name -> mcenter.token.PLATFORM
	8,  // 2: mcenter.token.QueryTokenRequest.user_type:type_name -> mcenter.user.TYPE
	9,  // 3: mcenter.token.QueryTokenRequest.grant_type:type_name -> mcenter.token.GRANT_TYPE
	10, // 4: mcenter.token.QueryTokenRequest.type:type_name -> mcenter.token.TOKEN_TYPE
	11, // 5: mcenter.token.QueryTokenRequest.block_type:type_name -> mcenter.token.BLOCK_TYPE
	0,  // 6: mcenter.token.DescribeTokenRequest.describe_by:type_name -> mcenter.token.DESCRIBY_BY
	1,  // 7: mcenter.token.RPC.ValidateToken:input_type -> mcenter.token.ValidateTokenRequest
	12, // 8: mcenter.token.RPC.ValidateToken:output_type -> mcenter.token.Token
