...
const (
	RPC_DescribeDomain_FullMethodName = "/mcenter.domain.RPC/DescribeDomain"
	RPC_QueryDoamin_FullMethodName    = "/mcenter.domain.RPC/QueryDoamin"
)
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mcenter.domain.RPC",
