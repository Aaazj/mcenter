...
PKG := "github.com/Aaazj/mcenter"
IMAGE_PREFIX := "github.com/Aaazj/mcenter"
...
gen: ## Init Service
	@protoc -I=..  -I=common/pb --go_out=. --go_opt=module=${PKG} --go-grpc_out=. --go-grpc_opt=module=${PKG} ../mcenter/apps/*/pb/*.proto
	@go fmt ./...
